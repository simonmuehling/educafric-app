            ...
            <div className="bg-white dark:bg-card-foreground/5 rounded-2xl shadow-2xl overflow-hidden border border-border">
              <div className="aspect-video relative group">
                {!isPlaying ? (
                  ...
                  // Actual demo video player with new videos
                  <video
                  ...
                  >
                    <source 
                      ...
                      type="video/mp4"
                    />
                    <p className="text-white p-8 text-center bg-gradient-to-br from-purple-600 via-pink-600 to-blue-600">
                      {language === 'fr' 
                        ? 'Votre navigateur ne supporte pas la lecture vidéo HTML5. Veuillez essayer un navigateur moderne.'
                        : 'Your browser does not support HTML5 video playback. Please try a modern browser.'
                      }
                    </p>
                  </video>
                )}
