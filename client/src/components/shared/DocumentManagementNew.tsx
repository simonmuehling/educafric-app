...
const DocumentManagementNew: React.FC = () => {
  ...
  const getDocumentUrl = (docId: number): string => {
    const mappings: { [key: number]: string } = {
      ...
      6: '/documents/kit-prospection-educafric-complet.pdf',
      7: '/documents/Demande_Etablissement_1753390157502.pdf',
      8: '/documents/Demande_ministre-8_1753390184314.pdf',
      9: '/documents/tarifs-complets-educafric.pdf',
      10: '/documents/parents_1753390442002.pdf',
      11: '/documents/00-index-documents-alphabetique.html',
      12: '/documents/guide-notifications-educafric.pdf',
      13: '/documents/tarifs-complets-educafric.pdf',
      14: '/documents/brochure-commerciale-educafric-fr.html',
      15: '/documents/geolocalisation-resume-francais.pdf',
      16: '/documents/contrat-partenariat-educafric-2025.html',
      17: '/documents/proposition-tarifaire-personnalisee-fr.html',
      18: '/documents/argumentaire-vente-educafric-fr.html',
