      ...
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="commercial" className="mt-6">
            {createDynamicModule('siteadmin-commercial')}
          </TabsContent>

          <TabsContent value="educafric-numbers" className="mt-6">
            {createDynamicModule('siteadmin-educafric-numbers')}
          </TabsContent>
          ...
          <TabsContent value="security" className="mt-6">
            {createDynamicModule('siteadmin-security')}
          </TabsContent>
          ...
          <TabsContent value="system" className="mt-6">
            {createDynamicModule('siteadmin-system')}
          </TabsContent>
