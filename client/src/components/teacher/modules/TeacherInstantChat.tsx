...
const TeacherInstantChat: React.FC = () => {
  ...
  const t = {
    fr: {
      ...
      subtitle: 'Communiquez en temps réel avec les parents',
      conversations: 'Conversations',
      contacts: 'Contacts',
      noConversations: 'Aucune conversation',
      startChatting: 'Commencez par sélectionner un contact',
      noContacts: 'Aucun contact disponible',
      noContactsDesc: 'Les parents de vos élèves apparaîtront ici',
    ...
    en: {
      ...
      subtitle: 'Communicate in real-time with parents',
      conversations: 'Conversations',
      contacts: 'Contacts',
      noConversations: 'No conversations',
      startChatting: 'Start by selecting a contact',
      noContacts: 'No contacts available',
      noContactsDesc: 'Parents of your students will appear here',
  ...
  // Fetch contacts (parents of students in teacher's classes)
    ...
    return (
      <div className="flex flex-col h-[calc(100vh-200px)] bg-white rounded-lg shadow-sm border">
        ...
        <div className="flex items-center gap-3 p-4 border-b bg-gray-50">
          ...
          <div className="w-10 h-10 rounded-full bg-[#7C5CFC] flex items-center justify-center text-white font-semibold">
        ...
        <div className="p-4 border-t bg-gray-50">
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="bg-[#7C5CFC] hover:bg-[#6B4FE0]"
            >
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                <MessageCircle className="w-6 h-6 text-[#7C5CFC]" />
                {labels.title}
                {totalUnread > 0 && (
              ...
              {loadingConversations ? (
                ...
                <div className="space-y-2">
                  {filteredConversations.map((conv) => (
                    ...
                    >
                      <div className="w-12 h-12 rounded-full bg-[#7C5CFC] flex items-center justify-center text-white font-semibold">
                  ...
                  {filteredContacts.map((contact) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {contact.studentName && (
                          <p className="text-sm text-gray-500 truncate">
                            {labels.studentOf} {contact.studentName}
                          </p>
                        )}
                      </div>
...
export default TeacherInstantChat;
