...
router.post('/generate-t3', async (req, res) => {
  try {
    ...
    const templateData: BulletinTemplateData = {
      ...
      teacherComments: evaluations?.teacherComments || "",
      directorComments: evaluations?.directorComments || "",
