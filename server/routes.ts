  ...
  app.get("/api/director/teachers", requireAuth, requireAnyRole(['Director', 'Admin']), async (req, res) => {
    try {
      ...
      if (isSandboxUser) {
        ...
        // Mock teachers data for sandbox/demo users synchronized with sandbox.ts
        teachers = [
          { id: 1, firstName: 'Catherine', lastName: 'Essola', subject: 'Mathématiques', email: 'catherine.essola@test.educafric.com', isActive: true, experience: 8, canTeachTimetable: true, availability: ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi'], classes: ['6ème A', '5ème A'], canSignBulletins: true, digitalSignatureActive: true, phone: '+237677123456' },
          { id: 2, firstName: 'François', lastName: 'Biya', subject: 'Français', email: 'francois.biya@test.educafric.com', isActive: true, experience: 12, canTeachTimetable: true, availability: ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi'], classes: ['5ème B', '4ème B'], canSignBulletins: true, digitalSignatureActive: true, phone: '+237677123457' },
          { id: 3, firstName: 'Vincent', lastName: 'Ondoa', subject: 'Histoire-Géographie', email: 'vincent.ondoa@test.educafric.com', isActive: true, experience: 6, canTeachTimetable: true, availability: ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi'], classes: ['4ème C', '3ème C'], canSignBulletins: false, digitalSignatureActive: false, phone: '+237677123458' },
          { id: 4, firstName: 'Jennifer', lastName: 'Smith', subject: 'Anglais', email: 'jennifer.smith@test.educafric.com', isActive: true, experience: 5, canTeachTimetable: true, availability: ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi'], classes: ['3ème D', '2nde A'], canSignBulletins: true, digitalSignatureActive: true, phone: '+237677123459' },
          { id: 5, firstName: 'André', lastName: 'Bikanda', subject: 'Sciences Physiques', email: 'a.bikanda@saintjoseph.edu', isActive: true, experience: 10, canTeachTimetable: true, availability: ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi'], classes: ['2nde B', '1ère S'], canSignBulletins: true, digitalSignatureActive: true, phone: '+237677123460' },
          { id: 6, firstName: 'Claire', lastName: 'Owono', subject: 'Sciences Naturelles', email: 'c.owono@saintjoseph.edu', isActive: true, experience: 7, canTeachTimetable: true, availability: ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi'], classes: ['1ère S', 'Terminale S'], canSignBulletins: true, digitalSignatureActive: true, phone: '+237677123461' }
        ];
      } else {
