            ...
            <table className="w-full print:text-[9px] border border-black" style={{lineHeight: isTechnicalBulletin ? '1.0' : '1.3', tableLayout: 'fixed'}}>
              ...
              <thead>
                <tr className="bg-gray-100">
                  <th className="border border-black p-1 font-bold text-center text-[9px] print:text-[9px]">
                  ...
                  return (
                    <tr key={rowKey}>
                      <td className={`border border-black ${cellPadding} text-[9px]`}>
                        ...
                        <div className="text-[8px] text-gray-600">{r.teacher || ''}</div>
                      </td>
                      <td className={`border border-black ${cellPadding} text-[9px] leading-tight`}>
                            ...
                            return (
                              <>
                                {(comp1 || fallbackParts[0]) && (
                                  <div className="text-[9px] font-medium border-b border-gray-200 pb-0.5">
                                    {comp1 || fallbackParts[0]}
                                  </div>
                                )}
                      ...
                      {showTwoColumns ? (
                        <>
                          <td className={`border border-black ${cellPadding} text-center text-[9px]`}>
                            {mk20}
                          </td>
                          <td className={`border border-black ${cellPadding} text-center text-[9px] font-bold ${Number(av20) < 10 ? 'text-red-600' : ''}`}>
                            {av20}
                          </td>
                        </>
                      ) : (
                      ...
                      <td className={`border border-black ${cellPadding} text-center text-[9px] font-bold`}>
                        <div>{r.grade || cote}</div>
                        <div className="text-[8px]">{minMax}</div>
                      </td>
                      <td className={`border border-black ${cellPadding} text-[9px]`}>
                        {(() => {
                        ...
                        {r.teacherComments && r.teacherComments.length > 0 ? (
                          <ul className="list-decimal list-inside space-y-0.5">
                            {r.teacherComments.map((commentText, index) => (
                              <li key={index} className="text-[8px]">{commentText}</li>
                            ))}
                          </ul>
                        ) : (
                  ...
                  const renderSectionSubtotal = (sectionName: string, sectionEntries: SubjectLine[]) => {
                    ...
                    return (
                      <tr className="bg-blue-50 font-semibold">
                        <td colSpan={2} className="border border-black p-1 text-[9px] italic text-blue-700">
                        ...
                        <td className="border border-black p-1 text-center text-[9px] font-bold">{sectionTotalCoef}</td>
                        <td className="border border-black p-1 text-center text-[9px] font-bold">{round2(sectionTotalMxCoef)}</td>
                        <td className="border border-black p-1 text-center text-[9px] font-bold">{sectionMoyenne}/20</td>
              ...
              <tfoot>
                <tr className="bg-gray-200">
                  <td className="border border-black p-1 font-bold text-[9px] text-center">TOTAL</td>
                  <td className="border border-black p-1"></td>
                  {showTwoColumns ? (
                    <>
                      <td className="border border-black p-1"></td>
                  ...
                  <td className="border border-black p-1 text-center font-bold text-[9px]">{totalCoef}</td>
                  <td className="border border-black p-1 text-center font-bold text-[9px]">{round2(totalMxCoef)}</td>
                  <td className="border border-black p-1"></td>
                  <td className="border border-black p-1"></td>
                  <td className="border border-black p-1"></td>
                </tr>
                <tr className="bg-gray-100">
                  <td className="border border-black p-1 font-bold text-[9px]">
                    {language === 'fr' ? 'MOYENNE DE L\'\u00c9LÈVE :' : 'STUDENT AVERAGE :'}
                  </td>
                  <td className={`border border-black p-1 text-center font-bold text-[9px] ${moyenne < 10 ? 'text-red-600' : ''}`}>
                    {moyenne}/20
                  </td>
            ...
            <table className="w-full text-[9px] border border-black">
              <tbody>
                ...
                <tr>
                  ...
                  <td rowSpan={3} className="border border-black p-1 text-[9px] align-top">
                ...
                <tr>
                  ...
                  <td colSpan={2} className="border border-black p-1 text-[9px] align-top">
                  ...
                  <td className="border border-black p-1 text-[9px] align-top">
                    <div className="font-bold mb-1">
