...
export function StudentIDCard({ student, school, isOpen, onClose, validUntil, schoolId }: StudentIDCardProps) {
  ...
  const cardColors = {
    ...
    frontBg: school.settings?.cardColors?.frontBgColor || '#ffffff',
    backBg: school.settings?.cardColors?.backBgColor || '#f8fafc'
  };
  ...
  const handlePrint = () => {
    ...
    const printStyles = `
      ...
      * {
      ...
      .front-card {
        background: linear-gradient(135deg, ${cardColors.frontBg} 0%, ${cardColors.frontBg}f5 50%, ${cardColors.frontBg}ee 100%) !important;
      ...
      .back-card {
        background: linear-gradient(135deg, ${cardColors.backBg} 0%, ${cardColors.backBg}f5 50%, ${cardColors.backBg}ee 100%) !important;
        border: 0.5mm solid #e2e8f0 !important;
      }
          ...
          <div ref={printRef} className="print-container" style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <div 
              ...
              style={{
                ...
                background: `linear-gradient(135deg, ${cardColors.frontBg} 0%, ${cardColors.frontBg}f5 50%, ${cardColors.frontBg}ee 100%)`,
            ...
            <div 
              ...
              style={{
                ...
                overflow: 'hidden',
                boxShadow: '0 4px 20px rgba(0, 0, 0, 0.25)',
                background: `linear-gradient(135deg, ${cardColors.backBg} 0%, ${cardColors.backBg}f5 50%, ${cardColors.backBg}ee 100%)`,
                border: '0.5mm solid #e2e8f0',
                fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif",
                ...
                <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column', padding: '2.5mm' }}>
                  <div style={{
                    ...
                    {school.logoUrl ? (
                      ...
                      <div style={{ width: '6mm', height: '6mm', background: 'white', borderRadius: '1mm', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '3.5mm', fontWeight: 800, color: cardColors.primary }}>E</div>
                    )}
                    <div style={{ flex: 1 }}>
                    ...
                    <div style={{ background: 'rgba(255,255,255,0.95)', color: cardColors.primary, fontSize: '1.8mm', fontWeight: 700, padding: '1mm 2mm', borderRadius: '1mm', textTransform: 'uppercase' }}>{text.studentCard}</div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: '3mm', flex: 1 }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', gap: '0.8mm' }}>
                      ...
                      <div style={{ display: 'grid', gap: '0.3mm' }}>
                        <div style={{ display: 'flex', gap: '0.5mm', whiteSpace: 'nowrap' }}><span style={{ fontSize: '1.3mm', color: '#6b7280', fontWeight: 600 }}>{text.studentId}:</span><span style={{ fontSize: '1.5mm', color: '#1f2937', fontWeight: 700 }}>{studentId}</span></div>
                        <div style={{ display: 'flex', gap: '0.5mm', whiteSpace: 'nowrap' }}><span style={{ fontSize: '1.3mm', color: '#6b7280', fontWeight: 600 }}>{text.class}:</span><span style={{ fontSize: '1.5mm', color: '#1f2937', fontWeight: 700 }}>{student.className}</span></div>
                        <div style={{ display: 'flex', gap: '0.5mm', whiteSpace: 'nowrap' }}><span style={{ fontSize: '1.3mm', color: '#6b7280', fontWeight: 600 }}>{text.academicYear}:</span><span style={{ fontSize: '1.5mm', color: '#1f2937', fontWeight: 700 }}>{academicYear}</span></div>
                      </div>
                      <div style={{ display: 'inline-flex', background: 'linear-gradient(90deg, #dcfce7 0%, #bbf7d0 100%)', color: '#166534', fontSize: '1.3mm', fontWeight: 600, padding: '0.5mm 1mm', borderRadius: '0.6mm', border: '0.2mm solid #86efac', width: 'fit-content', whiteSpace: 'nowrap', marginTop: '0.5mm' }}>✓ {text.validThru}: {validityDate}</div>
                    </div>
                    
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      <canvas className="qr-front-print" style={{ width: '14mm', height: '14mm', border: '0.2mm solid #e5e7eb', borderRadius: '0.8mm', padding: '0.3mm', background: 'white' }} />
